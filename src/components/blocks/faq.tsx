...
export function FaqBlock(b: Props) {
  return (
    <section className="relative my-40 w-full bg-t-red">
      <div className="site-container relative flex flex-col items-center justify-center pb-[74px] pt-[60px] max-lg:px-10 max-md:pb-[60px]">
