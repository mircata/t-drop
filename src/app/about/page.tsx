...
export default function AboutPage() {
  return (
    <>
      <section className="site-container flex flex-row">
        <div className="flex w-1/2 flex-col max-lg:w-full">
          <div className="flex flex-col gap-10 pt-10 max-lg:items-center max-lg:text-center">
            ...
            <p className="max-lg:w-[60%] max-md:w-[80%]">
            ...
            <div className="relative mt-[95px] flex w-full flex-col gap-10 pt-10 max-lg:items-center">
              <h2 className={headline}>Избираш твоята тема</h2>
              <div className={`${badgeNeon} left-[202px] top-[34px] w-1/2 rotate-[5deg] max-lg:left-[51px] max-lg:top-[-11px] max-lg:w-[139px] max-md:left-[78px] max-md:top-[-28px] max-md:w-[179px]`}>как?</div>
              <p className="max-lg:w-[60%] max-md:w-[80%]">
              ...
              <div className="relative mt-[94px] flex w-full flex-col justify-end gap-10 pt-10 max-lg:items-center">
                <h2 className={headline}>След това...</h2>
                <div className={`${badgeNeon} left-[-117px] top-[11px] w-1/2 -rotate-[8deg] max-lg:left-[10px] max-lg:top-[12px] max-lg:w-[182px] max-md:left-[69px] max-md:top-[-24px] max-md:w-[179px]`}>и ся кво?</div>
                <p className="max-lg:w-[60%] max-md:w-[80%]">
                ...
                <div className="flex flex-row items-end justify-center max-md:mt-[60px]">
                  <p className="max-lg:w-[60%] max-md:w-[80%]">Избирането се прави веднъж месеца и нямате право да смяна на избора.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="site-container mt-[149px] flex flex-row gap-10 max-lg:flex-col-reverse">
        <div className="relative flex w-full flex-col justify-end gap-10 pt-10 max-lg:items-center">
          ...
          <div className={`${badgeNeon} left-[308px] top-[-13px] w-[9.141%] rotate-[5deg] max-lg:left-[23px] max-lg:top-[186px] max-lg:w-[164px] max-md:left-[-11px] max-md:top-[1px] max-md:w-[179px]`}>кога?</div>
        </div>
      </section>

      <section className="site-container my-20 flex flex-col items-center">
        <p className="w-[90%] text-center font-dot text-[52px] leading-[1.12] max-md:text-[21px]">
          Остават <br /><b>12:24:10:035</b><br /> до следващия дроп
        </p>
      </section>

      <section className="site-container flex flex-row gap-10 max-lg:flex-col-reverse">
        <div className="flex w-[49.658%] flex-row items-start max-lg:w-full max-lg:flex-col max-lg:items-center">
          <p className="max-lg:w-[60%] max-lg:text-center max-md:w-[80%]">На тази дата изпращаме пратките, като самия ден в който пристига пратка зависи от куриерската фирма.</p>
        </div>
        <div className="flex flex-1 flex-row items-start justify-center max-md:mt-[60px]">
          <p className="max-lg:w-[60%] max-lg:text-center max-md:w-[80%]">С времето ще работим да подобрим процеса, и да измислим начин в който да получавате в деня в който е маркиран дропа.</p>
        </div>
      </section>

      <div className="mt-[120px]">
        <SocialFollow text="Последвай ни за още" />
      </div>
    </>
  );
}
